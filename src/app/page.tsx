  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gray-50" id="mission-vision">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">Our Vision & Mission</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Guiding our commitment to Rwanda's youth empowerment
            </p>
          </div>
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <Card className="border-green-200 bg-gradient-to-br from-green-600 to-green-700 text-white hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
              <CardHeader>
              ...
              <CardContent>
                <CardDescription className="text-green-100 text-base leading-relaxed">
                  "To empower Rwanda's youth to reach their full potential through talent and purpose."
                </CardDescription>
              </CardContent>
            </Card>

            <Card className="border-amber-200 bg-gradient-to-br from-amber-500 to-amber-600 text-white hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
              <CardHeader>
                <div className="w-12 h-12 bg-white/20 rounded-lg flex items-center justify-center mb-4">
              ...
              <CardContent>
                <CardDescription className="text-amber-50 text-base leading-relaxed">
                  "To discover, mentor, and support young Rwandan talents to thrive and positively impact their
                  communities."
                </CardDescription>
              </CardContent>
            </Card>
